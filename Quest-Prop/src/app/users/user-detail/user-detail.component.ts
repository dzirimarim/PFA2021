...
export class UserDetailComponent implements OnInit, OnChanges {
  ...
  dateChange(type: string, event: MatDatepickerInputEvent<Date>) {
    if( event.value != null){
    this.user.dateOfBirth = event.value.toLocaleDateString('ln', { year: 'numeric', month: 'numeric', day: 'numeric' });
    //console.log(event.value.toLocaleDateString('ln', { year: 'numeric', month: 'numeric', day: 'numeric' }));
